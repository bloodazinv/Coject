...
import com.jane.coject.adapters.MemberListItemsAdapter
import com.jane.coject.firebase.FirestoreClass
import com.jane.coject.model.Board
import com.jane.coject.model.User
...
class MembersActivity : BaseActivity() {
    ...
    private inner class SendNotificationToUserAsyncTask(val boardName: String, val token: String) :
        ...
        override fun doInBackground(vararg params: Any): String {
             ...
             * Detail HttpURLConnection class
             */
            ...
            try {
                ...
                // pass the title as per requirement as here we have added some text and board name.
                dataObject.put(Constants.FCM_KEY_TITLE, "Assigned to the Board $boardName")
                // pass the message as per requirement as here we have added some text and appended the name of the Board Admin.
                dataObject.put(
