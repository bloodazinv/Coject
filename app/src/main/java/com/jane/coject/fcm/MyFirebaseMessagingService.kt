...
import com.jane.coject.activities.MainActivity
import com.jane.coject.activities.SignInActivity
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendRegistrationToServer(token: String?) {
        ...
        val sharedPreferences =
            this.getSharedPreferences(Constants.COJECT_PREFERENCES, Context.MODE_PRIVATE)
        val editor: SharedPreferences.Editor = sharedPreferences.edit()
        editor.putString(Constants.FCM_TOKEN, token)
        editor.apply()
    }

    //Change the notification definition as add the parameters for title and message.)
    /**
    ...
    private fun sendNotification(title: String, message: String) {
        ...
        // START
        // will navigate them to the main screen if user is already logged in or to the login screen.
